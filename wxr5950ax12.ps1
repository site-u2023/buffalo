...
Invoke-WebRequest -Uri "https://downloads.openwrt.org/releases/23.05.3/targets/ipq807x/generic/openwrt-23.05.0-ipq807x-generic-buffalo_wxr-5950ax12-initramfs-uImage.itb" -OutFile "C:\openwrt\tftpdroot\WXR-5950AX12-initramfs.uImage"
Invoke-WebRequest -Uri "https://downloads.openwrt.org/releases/23.05.3/targets/ipq807x/generic/openwrt-23.05.0-ipq807x-generic-buffalo_wxr-5950ax12-squashfs-sysupgrade.bin" -OutFile "C:\openwrt\buffalo\openwrt-ipq807x-generic-buffalo_wxr-5950ax12-squashfs-sysupgrade.bin"
